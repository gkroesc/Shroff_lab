...
def main():
    ...
    positions = [3,5] #<--- Put the positions here separated by commas ','. Ex. positions = [0,2,1,3] It does not need to be in order. OMIT ALL SPACES. 
    #______________________________________________________________________________________________________________________________
    ...
    for position in positions:
        ...
        prediction_dir = 'X:\\Cell_Tracking_Project\\RW10742\\Hyp_Screen\\112221_multi\\Pos{}\\SPIMB\\Reg_Sample'.format(position) 
