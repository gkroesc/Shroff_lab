...
These are the three Deep Learning networks that are applied to diSPIM images. Our current 3D-RCAN model is used on any data set that contains only nuclei. Green untwisting strain images should use the Densenet model, and red untwisting images should use the RLN model.
## 3D RCAN
